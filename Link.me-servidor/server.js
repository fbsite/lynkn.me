...
const serviceAccount = require('./Link.me-servidor/linkn-4d006-firebase-adminsdk-fbsvc-1bebe35a99.json'); // <-- ATUALIZE AQUI: Coloque o caminho para o seu ficheiro de chave
